...
{ 
    ...
    public static async Task fn_CallHttpResponse(string strType, string strBase, string strPath, string user, string pwd, string token, string body)
    {
        string userpwd = "";
        userpwd = user + ":" + pwd;
        ...
        var authValue = new AuthenticationHeaderValue("Basic", Convert.ToBase64String(Encoding.UTF8.GetBytes(userpwd)));
        ...
        client.DefaultRequestHeaders.Authorization = authValue;
            ...
            client.DefaultRequestHeaders.Add("Usuario", user);
